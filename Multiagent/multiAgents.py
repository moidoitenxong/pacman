...
class MinimaxAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        def minimax(agent, depth, gameState):
          if gameState.isLose() or gameState.isWin() or depth == self.depth: #win/lose/depth
...
class AlphaBetaAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        def alphabetaprune(agent, depth, gameState, a, b):
          if gameState.isLose() or gameState.isWin() or depth == self.depth: #lose/win/depth
            return self.evaluationFunction(gameState)
          if agent == 0: #pacman
...
def betterEvaluationFunction(currentGameState):
    ...
    # Tinh khoang cach cua pacman den cac con ma va kiem tra so cac con ma co khoang cach <= 1 quanh pacman
